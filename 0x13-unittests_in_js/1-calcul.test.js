...
describe('calculateNumber', function () {
  ...
  it('should work with rounding', function () {
    assert.equal(calculateNumber(3.4, 4.2), 7);
  });
  it('should work without rounding', function () {
    assert.equal(calculateNumber(3.0, 4.0), 7);
  });
  it('should work without rounding', function () {
    assert.equal(calculateNumber(-3, 4), 1);
  });
  it('should work without rounding', function () {
    assert.equal(calculateNumber(3, - 4), -1);
  });
  it('should work with rounding', function () {
    assert.equal(calculateNumber(-3.4, 4.5), 2);
  });
  it('should work with rounding', function () {
      assert.equal(calculateNumber(-3.5, 2), -1);
  });
